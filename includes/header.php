        ...
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:info@example.com">leminhhoang61tk@gmail.com</a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">HOTLINE: </p>
              <a href="tel:61-1234-5678-09">01224515616</a> </div>
...
foreach($results as $result)
	{
	 ...
	 echo htmlentities($result->FullName); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
           ...
           <?php if($_SESSION['login']){?>
            ...
            <li><a href="my-booking.php">Xe đã book</a></li>
            <li><a href="logout.php">Đăng xuất</a></li>
            <?php } else { ?>
            <li><a href="#loginform"  data-toggle="modal" data-dismiss="modal">Thông tin cá nhân</a></li>
              <li><a href="#loginform"  data-toggle="modal" data-dismiss="modal">Đổi mật khẩu</a></li>
            <li><a href="#loginform"  data-toggle="modal" data-dismiss="modal">Xe đã book</a></li>
