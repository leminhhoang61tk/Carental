      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <p>Ở đây chúng tôi có hàng nghìn sự lựa chọn</p>
            <a href="car-listing.php" class="btn">TÌM XE<span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
